...
const Contact = () => {
    return (
        <section className='w-full items-center justify-center flex mx-auto relative bg-white' id='contact'>
                    ...
                    <div className='flex flex-col md:flex-row items-center justify-center w-full space-x-0 md:space-x-6 lg:space-x-12 space-y-5 md:space-y-0 mt-6'>
                        <a href='mailto:team@spartans.com' className='text-slate-500 space-x-3 text-sm hover:text-slate-500'>
                            <div className='flex items-center justify-start gap-x-3 bg-slate-100 rounded-lg w-80 px-8 py-4'>
                                <Mail size={24} strokeWidth={1.5} className='w-8 h-8 object-cover' />
                                team@spartans.com
                            </div>
                        </a>
                        <a href='tel:123456789' className='text-slate-500 text-sm hover:text-slate-500'>
                            <div className='flex items-center justify-start gap-x-3 bg-slate-100 rounded-lg w-80 px-8 py-4'>
                                <Smartphone size={24} strokeWidth={1.5} className='w-8 h-8 object-cover' />
                                +91 123 456 7890
                            </div>
                        </a>
                    </div>
